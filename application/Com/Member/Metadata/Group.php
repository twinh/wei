...
class Com_Member_Metadata_Group extends Com_Metadata
{
    ...
    public function sanitiseListOperation($value, $name, $data, $copyData)
    {
        ...
        $lang = Qwin::call('-lang');
        $set = $this->getAsc();
        $html = Qwin_Util_Html::jQueryButton($url->url($set, array('action' => 'AllocatePermission', $primaryKey => $copyData[$primaryKey])), $lang->t('ACT_ALLOCATE_PERMISSION'), 'ui-icon-person')
