...
class Trex_Management_Controller_Namespace extends Trex_Controller
{
    ...
    {
        return Qwin_Helper_Html::jQueryButton($this->_url->createUrl($this->_set, array('module' => 'Module', 'action' => 'List', 'name' => $copyData['namespace'])), $this->_lang->t('LBL_ACTION_VIEW_MODULE'), 'ui-icon-lightbulb')
            . Qwin_Helper_Html::jQueryButton($this->_url->createUrl($this->_set, array('module' => 'Module', 'action' => 'Add', 'name' => $copyData['namespace'])), $this->_lang->t('LBL_ACTION_ADD_MODULE'), 'ui-icon-plus')
            . Qwin_Helper_Html::jQueryButton('javascript:if(confirm(Qwin.Lang.MSG_CONFIRM_TO_DELETE)){window.location=\'' . $this->_url->createUrl($this->_set, array('action' => 'Delete', 'name' => $copyData['namespace'])) . '\';}', $this->_lang->t('LBL_ACTION_DELETE'), 'ui-icon-closethick');
    }
}
