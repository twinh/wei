 ...
 * @internal
 */
final class IsGreaterThanOrEqualTest extends BaseValidatorTestCase
{
    /**
    ...
    public static function providerForGreaterThanOrEqual()
    {
        return [
            [7, 6],
            [7, 7],
    ...
    public static function providerForNotGreaterThanOrEqual()
    {
        return [
            [7, 8],
            [0.1, 0.2],
