...
https://secure.gravatar.com/avatar/55502f40dc8b7c769880b10874abc9d0?s=80&d=mm
URL
            , $url);
    }
    ...
    public function testDefaultImage()
    {
        ...
        $url = $this->gravatar('test@example.com');
        $this->assertEquals($this->getUrl('55502f40dc8b7c769880b10874abc9d0?s=80&d=monsterid'), $url);
    }
    ...
    public function testSize()
    {
        ...
        $this->assertEquals($this->getUrl('55502f40dc8b7c769880b10874abc9d0?s=' . $largeSize . '&d=mm'), $url);

        $url = $this->gravatar->small('test@example.com');
        $smallSize = $this->gravatar->getOption('smallSize');
        $this->assertEquals($this->getUrl('55502f40dc8b7c769880b10874abc9d0?s=' . $smallSize . '&d=mm'), $url);
    }
    ...
    public function testRating()
    {
        ...
        $this->assertEquals($this->getUrl('55502f40dc8b7c769880b10874abc9d0?s=80&d=mm&r=g'), $url);
    }

    private function getUrl($url)
    {
        return 'http://www.gravatar.com/avatar/' . $url;
    }
}
