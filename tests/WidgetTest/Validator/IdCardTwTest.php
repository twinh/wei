...
class IdCardTwTest extends TestCase
{
    ...
    {
        $this->assertTrue($this->is('idCardTw', $input));
        
        $this->assertFalse($this->is('notIdCardTw', $input));
    }
    ...
    {
        $this->assertFalse($this->is('idCardTw', $input));
        
        $this->assertTrue($this->is('notIdCardTw', $input));
    }
