...
class Lang extends ArrayWidget
{
     ...
     * 根据模块标识加载语言
     *
     * @param  string|Widget_Module $module 模块标识
     ...
     * 加载微件语言
     *
     * @param  Widget_Widget|string $widget 微件对象或名称
     * @return false|Lang_Widget  语言文件不存在|加载成功
     */
    public function appendByWidget($widget)
    {
        if ($widget instanceof Widget_Widget) {
            $path = $widget->getPath();
        } else {
     ...
     * @return Widget_Application_Language|false 当前对象|失败
     */
     ...
     * @return Widget_Application_Language 当前对象
     */
