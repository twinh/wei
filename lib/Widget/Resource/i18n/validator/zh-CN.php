...
return array(
    ...
    'This file is too large({{ size }}), allowed maximum size is {{ maxSize }}' => '该文件太大了({{ size }}字节),允许的最大文件大小为{{ maxSize }}字节',
    'This file is too small({{ size }}), expected minimum size is {{ minSize }}' => '该文件太小了({{ size }}字节),允许的最小文件大小为{{ minSize }}字节',
